...
fn test_length(){
	{
	let mut k=compt::dfs_order::CompleteTree::from_vec(vec![0,1,2,3,4,5,6],3).unwrap();
...
#[test]
fn dfs_inorder_mut(){
	let mut k=compt::dfs_order::CompleteTree::from_vec(vec![3,1,2,0,4,5,6],3).unwrap();
...
#[test]
fn dfs(){
	let k=compt::dfs_order::CompleteTree::from_vec(vec![0,1,2,3,4,5,6],3).unwrap();
...
#[test]
fn bfs(){
	let k=compt::bfs_order::CompleteTree::from_vec(vec![0,1,2,3,4,5,6],3).unwrap();
